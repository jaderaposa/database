...
<head>
    ...
    <title> Update Appointment Ticket | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="appointmentupdate.php" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li>
                                        <button onClick="window.location.href='appointments.php';" type="button" class="btn btn-info" href="appointments.php">Back</button>
                                    </li>
                                </ul>
                                <br>
                                <br>           
                                ...
                                <div>
                                    <input type="hidden" name="id" value="<?php echo $row['Appointment_ID']; ?>" class="form-control"> <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            $valid_values = array();
                                            while($user_row = $result->fetch_assoc()) {
                                                $valid_values[] = $user_row['Staff_ID'];
                                            }
                                            $conn->close();

                                            // Retrieve the previous value for this field
                                            $previous_value = $row['Staff_ID']; // Replace with code that retrieves the previous value
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            $valid_values = array();
                                            while($user_row = $result->fetch_assoc()) {
                                                $valid_values[] = $user_row['Counselor_ID'];
                                            }
                                            $conn->close();

                                            // Retrieve the previous value for this field
                                            $previous_value = $row['Counselor_ID']; // Replace with code that retrieves the previous value
                                    ...
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input type="text"  class="form-control" value="<?php echo $row['Date_Start']; ?>" placeholder="MM/DD/YYYY" name="date_start" required>
                                        </div>
                                    </div>
                                    <label for="date_end">Date End</label>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input type="text"  class="form-control" value="<?php echo $row['Date_End']; ?>" placeholder="MM/DD/YYYY" name="date_end" required>
                                        </div>
                                    </div>
                                    <label for="counseling_type">Counseling Type</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" value="<?php echo $row['Counseling_Type']; ?>" placeholder="" name="counseling_type" required>
                                        </div>
                                    </div>
                                    <label for="appointment_purpose">Appointment Purpose</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" value="<?php echo $row['Appointment_Purpose']; ?>" placeholder="" name="appointment_purpose" required>
                                        </div>
                                    </div>
