...
<head>
    ...
    <title> Update Counselor | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="counselorupdate.php" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li>
                                        <button onClick="window.location.href='counselors.php';" type="button" class="btn btn-info" href="users.php">Back</button>
                                    </li>
                                </ul>
                                <br>
                                <br>           
                                ...
                                <div>
                                    <input type="hidden" name="id" value="<?php echo $row['Counselor_ID']; ?>" class="form-control"> <br>

                                    <label for="counselorname">Name</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" value="<?php echo $row['Counselor_Name']; ?>" placeholder="" name="counselorname" required>
                                        </div>
                                    </div>
                                    <label for="counseloradd">Address</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" value="<?php echo $row['Counselor_Address']; ?>" placeholder="" name="counseloradd">
                                        </div>
                                    </div>
                                    <label for="counselorphoneno">Phone Number</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" value="<?php echo $row['Counselor_PhoneNo']; ?>" placeholder="" name="counselorphoneno" required>
                                        </div>
                                    </div>
                                    <label for="counselorspecialty">Specialty/Forte</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" value="<?php echo $row['Counselor_Specialty']; ?>" placeholder="" name="counselorspecialty" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex;justify-content: space-between;width: 30%;position: relative;align-items: flex-end;">
                                        &nbsp;&nbsp;&nbsp;
                                        <input type="file" class="form-control" name="image" id="image" min="1" value="<?php echo $row['Counselor_Img']; ?>" accept="image/*">
