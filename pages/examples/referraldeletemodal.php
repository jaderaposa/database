...
<div class="modal fade" id="deleteModal<?php echo $row['Referral_ID']?>" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLabel"> Delete Referral Data </h5>
			...
			<div class="modal-body">
				...
				<h1> 
					Do you want to delete this Referral Data?
				</h1>                                                           
			</div>
			<div class="modal-footer">
				<a href='referraldelete.php?Referral_ID=<?php echo $id; ?>'>
