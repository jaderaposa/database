<?php 
    ...
    $counseloraddress = $_POST['counseloradd'];
    $counselorphone = $_POST['counselorphoneno'];
    $counselorspecialty = $_POST['counselorspecialty'];
    ...
    $query = "INSERT INTO counselors VALUES ('','$counselorname', '$counseloraddress', '$counselorphone', '$counselorspecialty','$filename')";


    if($conn->query($query) === TRUE) {
        echo "<script>window.alert('Counselor Successfully Added!'); </script>";
        echo "<script>window.location.replace('counselors.php');</script>";
    } else {
