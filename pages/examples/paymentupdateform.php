...
<head>
    ...
    <title> Update Payment Ticket | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="paymentupdate.php" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li>
                                        <button onClick="window.location.href='payments.php';" type="button" class="btn btn-info" href="payments.php">Back</button>
                                    </li>
                                </ul>
                                <br>
                                <br>           
                                ...
                                <div>
                                    <input type="hidden" name="id" value="<?php echo $row['Payment_ID']; ?>" class="form-control"> <br>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" value="<?php echo $row['Amount']; ?>" placeholder="" name="amountdue" required>
                                        </div>
                                    </div>
                                    <label for="dop">Date of Payment</label>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input type="text"  class="form-control" value="<?php echo $row['DOP']; ?>" placeholder="MM/DD/YYYY" name="dop" required>
                                        </div>
                                    </div>
                                    <label for="mop">Mode of Payment</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" value="<?php echo $row['MOP']; ?>" placeholder="" name="mop" required>
                                        </div>
                                    </div>
