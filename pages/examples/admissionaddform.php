...
<head>
    ...
    <title> Admission Create | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="admissionadd.php" enctype="multipart/form-data">
                <div class="row clearfix">
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <li>
                                <button onClick="window.location.href='admissions.php';" type="button" class="btn btn-info" href="users.php">Back</button>
                                </li>
                            </ul>
                                <br>
                                <br>                          
                                ...
                                <div class="margintop20px">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input type="text"  class="form-control" placeholder="MM/DD/YYYY" name="date_of_admission" required>
                                        </div>
                                    </div>
                                    <label for="admission_description">Description</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="" name="admission_description" required>
                                        </div>
                                    </div>
