...
<head>
    ...
    <title> Update Referral Ticket | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            <!-- <div class="block-header">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-8">
                    <div class="card">
                        ...
                        $query = "SELECT * FROM referrals WHERE Referral_ID = '$referral_id'";
            ...
            <form method="POST" action="referralupdate.php" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li>
                                        <button onClick="window.location.href='referrals.php';" type="button" class="btn btn-info" href="referrals.php">Back</button>
                                    </li>
                                </ul>
                                <br>
                                <br>           
                                ...
                                <div>
                                    <input type="hidden" name="id" value="<?php echo $row['Referral_ID']; ?>" class="form-control"> <br>
