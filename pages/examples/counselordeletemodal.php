...
<div class="modal fade" id="deleteModal<?php echo $row['Counselor_ID']?>" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<h1> 
					Do you want to delete this Staff Data?
				</h1>                                                           
			</div>
			<div class="modal-footer">
				<a href='counselordelete.php?Counselor_ID=<?php echo $id; ?>'>
