...
<head>
    ...
    <title> Add Counselor | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="counseloradd.php" enctype="multipart/form-data">
                <div class="row clearfix">
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <li>
                                <button onClick="window.location.href='counselors.php';" type="button" class="btn btn-info" href="counselors.php">Back</button>
                                </li>
                            </ul>
                                <br>
                                <br>                          
                                ...
                                <div class="margintop20px">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="" name="counselorname" required>
                                        </div>
                                    </div>
                                    <label for="counseloradd">Address</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" placeholder="" name="counseloradd">
                                        </div>
                                    </div>
                                    <label for="counselorphoneno">Phone Number</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="" name="counselorphoneno" required>
                                        </div>
                                    </div>
                                    <label for="counselorspecialty">Specialty/Forte</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" placeholder="" name="counselorspecialty" required>
                                        </div>
                                    </div>
