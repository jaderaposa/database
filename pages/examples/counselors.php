...
<head>
    ...
    <title> Counselor List | OGCS </title>
    <!-- Favicon-->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0px;">
                    <div class="card">
                        <div class="header" style="display: flex; justify-content:space-between;padding: 15px;">
                            ...
                            <section>
                            <a class='btn btn-secondary' href='counseloraddform.php'>Add</a>
                            </section>
                            </ul>
                        </div>
                            <div class="body">
                                    ...
                                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Specialty&nbsp;&nbsp;<i class="fa-solid fa-map-location-dot"></i>&nbsp;&nbsp;</th>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['Counselor_Address']; ?></td>
                                                <td><?php echo $row['Counselor_PhoneNo']; ?></td>
                                                <td><?php echo $row['Counselor_Specialty']; ?></td>
                                                <td class="jaded" style="text-align: center;">
                                                    <a class='btn btn-primary' style="background:#0c0ca9;" href='counselordisplay.php?Counselor_ID=<?php echo $row['Counselor_ID']; ?>'>VIEW  <i class="fa fa-search"  aria-hidden="true"></i></a>
                                                    <a class='btn btn-success' href='counselorupdateform.php?Counselor_ID=<?php echo $row['Counselor_ID']; ?>'>UPDATE  <i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                    <button type="button" class="btn btn-danger" data-target="#deleteModal<?php echo $row['Counselor_ID']; ?>" data-toggle="modal">DELETE  <i class="fa fa-trash" aria-hidden="true"></i></button>
                                                </td>
                                            <?php include "counselordeletemodal.php"; ?>    
                                            </tr>
                                        <?php                                      
                                        }                                                                 
                                        ?>
