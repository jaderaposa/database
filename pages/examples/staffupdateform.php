...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="staffupdate.php" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li>
                                        <button onClick="window.location.href='staffs.php';" type="button" class="btn btn-info" href="users.php">Back</button>
                                    </li>
                                </ul>
                                <br>
                                <br>           
                                ...
                                <div>
                                    <input type="hidden" name="id" value="<?php echo $row['Staff_ID']; ?>" class="form-control"> <br>

                                    <label for="staffname">Full Name</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" value="<?php echo $row['Staff_Name']; ?>" placeholder="" name="staffname" required>
                                        </div>
                                    </div>
                                    <label for="staffaddress">Pronoun</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" value="<?php echo $row['Staff_Address']; ?>" placeholder="" name="staffaddress">
                                        </div>
                                    </div>
                                    <label for="staffphone">Phone Number</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" value="<?php echo $row['Staff_PhoneNo']; ?>" placeholder="" name="staffphone" required>
                                        </div>
                                    </div>
                                    <label for="staffpos">Position</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  class="form-control" value="<?php echo $row['Staff_Position']; ?>" placeholder="" name="staffpos" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" style="display: flex;justify-content: space-between;width: 30%;position: relative;align-items: flex-end;">
                                        &nbsp;&nbsp;&nbsp;
                                        <input type="file" class="form-control" name="image" id="image" min="1" value="<?php echo $row['Staff_Img']; ?>" accept="image/*">
