...
<head>
    ...
    <title> View Payment Data | OGCS </title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if(isset($_GET['Payment_ID']))
                {
                    ...
                    $query = "SELECT payments.Payment_ID, users.User_Name, appointments.Appointment_ID, counselors.Counselor_Name, payments.Amount, payments.DOP, payments.MOP
                            FROM payments
                    ...
                    {
                        $payment = mysqli_fetch_assoc($query_run);
            ?>
                                ...
                                <div class="card">
                                    <div class="module-border-wrap">
                                        <div class="body">
                                            ...
                                            <br>                                                 
                                            <br>                                                   
                                            <label for=""><u>Payment ID</u></label>
                                            ...
                                            <label for=""><u>Appointment No.</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$payment['Appointment_ID'];?>, <?=$payment['Counselor_Name'];?>
                                                </p>
                                            </div>
                                            <label for=""><u>Amount Paid</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$payment['Amount'];?>
                                                </p>
                                            </div>
                                            <label for=""><u>Date of Payment</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$payment['DOP'];?>
                                                </p>
                                            </div>
                                            <label for=""><u>Mode of Payment</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$payment['MOP'];?>
                                                </p>
                                            ...
                                            ?>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <a class='btn btn-danger' href='payments.php'>Back</a>
                                                <div>                                                                                                                                                                          
                                            </div>                        
                                        </div>
                                    </div>
