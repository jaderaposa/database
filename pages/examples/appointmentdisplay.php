...
<head>
    ...
    <title> View Appointment Data | OGCS </title>
    <!-- Favicon-->
        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if(isset($_GET['Appointment_ID']))
                {
                    ...
                    $query = "SELECT appointments.Appointment_ID, users.User_Name, staffs.Staff_Name, staffs.Staff_Position, counselors.Counselor_Name, counselors.Counselor_Specialty, appointments.Date_Start, appointments.Date_End, appointments.Counseling_Type, appointments.Appointment_Purpose
                            FROM appointments
                            JOIN users ON appointments.User_ID = users.User_ID
                            JOIN staffs ON appointments.Staff_ID = staffs.Staff_ID
                            JOIN counselors ON appointments.Counselor_ID = counselors.Counselor_ID
                            WHERE appointments.Appointment_ID = $appointment_id";
                    $query_run = mysqli_query($conn, $query);

                    if(mysqli_num_rows($query_run) > 0)
                    {
                        $appointment = mysqli_fetch_assoc($query_run);
            ?>
                                ...
                                <div class="card">
                                    <div class="module-border-wrap">
                                        <div class="body">
                                            ...
                                            <br>                                                 
                                            <br>                                                   
                                            <label for=""><u>Appointment ID</u></label>
                                            ...
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$appointment['Staff_Name'];?>,&nbsp;<?=$appointment['Staff_Position'];?>
                                                </p>
                                            </div>
                                            ...
                                            <label for=""><u>Appointment Date Start</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$appointment['Date_Start'];?>
                                                </p>
                                            </div>
                                            <label for=""><u>Appointment Date End</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$appointment['Date_End'];?>
                                                </p>
                                            </div>
                                            <label for=""><u>Type of Counseling</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                                    <?=$appointment['Counseling_Type'];?>
                                                </p>
                                            </div>
                                            <label for=""><u>Purpose of Appointment</u></label>
                                            <div class="form-group">                                                          
                                                <p class="form-control">
                                            ...
                                            ?>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <a class='btn btn-danger' href='appointments.php'>Back</a>
                                                <div>                                                                                                                                                                          
                                            </div>                        
                                        </div>
                                    </div>
