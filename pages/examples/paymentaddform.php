...
<head>
    ...
    <title> Payment Create | OGCS</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    <div class="container-fluid">
            ...
            <form method="POST" action="paymentadd.php" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-14 col-md-12 col-sm-10">          
                            <div class="body">
                                ...
                                <div class="margintop20px">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number"  class="form-control" placeholder="" name="appointmentno">
                                        </div>
                                    </div>
                                    <label for="amountdue">Amount Due</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="number" class="form-control" placeholder="" name="amountdue" required>
                                        </div>
                                    </div>
                                    <label for="dop">Date of Payment</label>
                                    <div class="form-group">
                                        <div class="form-line" id="bs_datepicker_container">
                                            <input type="text"  class="form-control" placeholder="MM/DD/YYYY" name="dop" required>
                                        </div>
                                    </div>     
                                    <label for="mop">Mode of Payment</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" placeholder="" name="mop" required>
                                        </div>
                                    </div>
